...
namespace Thought.vCards
{
    ...
    public abstract class vCardReader
    {
        ...
        /// </returns>
        public List<vCard> ReadList(TextReader reader)
        {
			List<vCard> cardList = new List<vCard>();
            ReadIntoList(cardList, reader);
            return cardList;
        }
        ...
        /// </param>
		public abstract void ReadIntoList(List<vCard> card, TextReader reader);


		/// <summary>
		///     Reads a vCard from the specified input stream. [Deprecated]
		/// </summary>
		/// <param name="reader">
		///     A text reader that points to the beginning of
		///     a vCard in the format expected by the implementor.
		...
		{
			vCard cardList = new vCard();
			ReadInto(cardList, reader);
			return cardList;
		}
		...
		/// <summary>
		///     Reads vCard information from a text reader and
		///     populates into an existing vCard object. [Deprecated]
		/// </summary>
		/// <param name="card">
		///     An initialized vCard object.
		/// </param>
