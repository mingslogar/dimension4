...
{
    [DataContract(Name = "TopicTranslation")]
    public sealed class TopicTranslation
    {
        ...
        public TopicTranslation(CultureInfo culture, string topic)
        {
            _culture = culture;
            _topic = topic;
        }
        ...
        {
            return String.Format("{0} ({1})", _culture.NativeName, _topic);
        }
    }
}
