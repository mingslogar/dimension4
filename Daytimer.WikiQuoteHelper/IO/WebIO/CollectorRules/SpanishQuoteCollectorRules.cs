...
//
// Filename: SpanishQuoteCollectorRules.cs
...
namespace WikiquoteScreensaverLib.IO.WebIO.CollectorRules
{
    ...
    /// ...
    /// </summary>
    public sealed class SpanishQuoteCollectorRules 
        : QuoteCollectorRules
    {
        ...
        public SpanishQuoteCollectorRules()
            : base(CultureId, QuoteRegexPattern, WikiSectionsToSkip, null, null, null)
        {
        }
    }
}
