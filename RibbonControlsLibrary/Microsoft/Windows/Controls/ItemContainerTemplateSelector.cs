    ...
    internal class DefaultItemContainerTemplateSelector : ItemContainerTemplateSelector
    {
        ...
        private static object FindTemplateResourceInternal(DependencyObject target, object item)
        {
            ...
            if (bestMatch >= exactMatch)
            {
				...
				object appResource = FindTemplateResourceFromApp(keys, exactMatch, ref bestMatch);//target, 
		...
		internal static object FindTemplateResourceFromApp(ArrayList keys, int exactMatch, ref int bestMatch)//DependencyObject target, 
        {
            object resource = null;
            int k;
